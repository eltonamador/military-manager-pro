...
const MilitaryTable = ({ 
  ...
  const handleEdit = (index: number) => {
    setEditingMilitary(militaryList[index]);
    setEditingIndex(index);
  };

  const handleSave = (updatedMilitary: Military) => {
    if (editingIndex !== null && onEdit) {
      onEdit(editingIndex, updatedMilitary);
    }
  ...
  return (
    <>
      ...
      <EditMilitaryDialog
        isOpen={editingMilitary !== null}
        onClose={() => setEditingMilitary(null)}
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={() => {
              ...
              if (editingMilitary && editingIndex !== null) {
                handleSave(editingMilitary);
              }
            }}>
              Editar Existente
            </AlertDialogAction>
